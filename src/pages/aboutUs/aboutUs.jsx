  ...
  return (
    <div className="container">
      ...
      <div className="bottom-container">
        <p className='descrip'>The above services are provided by our Vehicle Repair mobile application.<br></br> Join us today with our company to make the company and your life better!</p>
